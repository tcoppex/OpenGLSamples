...
NvAssetLoader_debug_lflags    += -Wl,--no-as-needed $(addprefix -l, $(NvAssetLoader_debug_libraries))
...
NvAssetLoader_release_lflags    += -Wl,--no-as-needed $(addprefix -l, $(NvAssetLoader_release_libraries))
